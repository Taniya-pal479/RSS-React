...
const SubCategoryDetail = lazy(
  () => import("./pages/Subcategory.tsx/SubCategoryDetail"),
);
const UploadFile = lazy(() => import("./pages/Files/UploadFile"));
const ContentTypeManager = lazy(
  () => import("./pages/ContentType/ContentTypeManger"),
);
const ContentTypeForm = lazy(
  () => import("./components/common/ContentTypeForm"),
);
const ContentTypeDetail = lazy(
  () => import("./pages/ContentType/ContentTypeDetail"),
);
...
import FileYearManager from "./pages/Files/FileYearManager";
import FileYearDetails from "./pages/Files/FileYearDetails";
          ...
          {isAuthenticated ? (
            <Route element={<ProtectedRoute />}>
              <Route element={<DashboardLayout />}>
                ...
                <Route path="/year" element={<FileYearManager />} />
                <Route path="/year/:year" element={<FileYearDetails />} />
              </Route>
            </Route>
          ) : (
