    ...
    <div className="min-h-screen bg-[#fafafa] flex items-center justify-center p-6">
      <div className="max-w-112.5 w-full bg-white rounded-4xl border border-gray-100 p-10 shadow-sm">
        <div className="text-center mb-10">
          ...
          <h1 className="text-[20px] font-bold text-rose-800">
            {t("sidebarHeading")}
          </h1>
          <h1 className="text-[20px] font-bold text-[#1a1a1a] m-5">
            {t("archives")}
          </h1>
        </div>
        ...
        <form onSubmit={handleLogin} noValidate className="space-y-6">
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-12 py-4 bg-[#f9fafb] border rounded-2xl outline-none transition-all ${
                  errors.email
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-4 bg-[#f97316] text-white font-bold rounded-2xl hover:bg-[#ea580c] transition-all shadow-[0_10px_20px_-5px_rgba(249,115,22,0.4)] flex items-center justify-center gap-2 active:scale-95 disabled:opacity-70"
          >
            {isLoading ? (
